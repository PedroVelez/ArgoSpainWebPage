...
%Leaflet libraries
=======
>>>>>>> 21910e9e26830a278f3a67923ea9c5b1f6437a05
...
fprintf(fid,'                center: esMovil ? [%d,%d] : [%d,%d],\n',MCentroArgoIb(1),MCentroArgoIb(2),MCentroArgoIb(1),MCentroArgoIb(2));
...
fprintf(fid,'	    var div = L.DomUtil.create(''div'', ''info legend'');\n');
fprintf(fid,'	        div.innerHTML  = ''<b><center>Argo Espa&ntilde;a: %d boyas y %d perfiles oceanogr&aacute;ficos medidos </b><br />''+\n',DataArgoEs.iactiva,sum(NTotalPerfiles));
fprintf(fid,'	                         ''<b>                 Último dato %s, actualizado el %s </b><br/></center>'';\n',datestr(LastJday),datestr(now));
fprintf(fid,'           div.style.background = "#ffffff";\n');
