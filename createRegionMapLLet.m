...
fprintf(fid,'			}).addTo(mymap).bindPopup(''<center><p>Boya <b><a href="https://fleetmonitoring.euro-argo.eu/float/''+perfilador[1]+''" target="_blank">''+perfilador[1]+''</a></b><br><b>''+perfilador[4]+''</b><br><br><b>Ultimo dato&nbsp;</b>''+perfilador[5]+''<br><b>Dato superficial&nbsp;</b>''+perfilador[6]+''<br><b>Dato profundo&nbsp;</b>''+perfilador[7]+''</p></center>'');\n');
fprintf(fid,'		}else if (perfilador[0] == 1) {\n');
fprintf(fid,'			L.marker([perfilador[2], perfilador[3]],{\n');
fprintf(fid,'			icon: buoyred,\n');
fprintf(fid,'			title: perfilador[4]+'' WMO ''+perfilador[1]+'' ''+perfilador[5],\n');
fprintf(fid,'			}).addTo(mymap).bindPopup(''<center><p>Boya <b><a href="https://www.argoespana.es/float/''+perfilador[1]+''.html" target="_blank">''+perfilador[1]+''</a></b><br><b>''+perfilador[4]+''</b><br><br><b>Ultimo dato&nbsp;</b>''+perfilador[5]+''<br><b>Dato superficial&nbsp;</b>''+perfilador[6]+''<br><b>Dato profundo&nbsp;</b>''+perfilador[7]+''</p></center>'');\n');
