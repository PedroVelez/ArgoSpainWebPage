...
if exist(fullfile(DirArgoData,'ar_greylist.txt'),'file')
    ...
    while feof(fid)==0
        ...
        if length(str)>2
            ...
            dateinic(i)=datenum(str2double(dateinicstr(1:4)), ...
                str2double(dateinicstr(5:6)),str2double(dateinicstr(7:8)));
            if in(4)-in(3)==8
                datefinastr=str(in(3)+1:in(4)-1);
                datefina(i)=datenum(str2double(datefinastr(1:4)), ...
                    str2double(datefinastr(5:6)),str2double(datefinastr(7:8)));
            end
        end
    end
