function  FileOutFHtml=ArgoEsStatusGraficos_WebPage(WMO,GlobalDS)
...
%% Read Metada data
MD=ArgoEsStatusGraficos_FunctionMetadata(WMO,GlobalDS.DirArgoData);
...
fprintf(fid,'<th width="403"><div align="left"><a href="http://www.oceanografia.es/argo/"><img src="http://www.oceanografia.es/argo/imagenes/logoargoes.png" border="0"></div></th>\n');
fprintf(fid,'<th width="325"><div align="right"><a href="http://www.ieo.es"><img src="http://www.oceanografia.es/argo/imagenes/logoieo.png" border="0"></a><a href="http://www.socib.es"><img src="http://www.oceanografia.es/argo/imagenes/logosocib.png" border="0"></a></div></th>\n');
fprintf(fid,'</tr>\n');
fprintf(fid,'</table>\n');
...
if exist(fileReport,'file')==2
    fprintf(fid,'<h3><div align="center"><a href="http://www.oceanografia.es/argo/Informes/%7dInformeLanzamiento.pdf">Acceso al informe de lanzamiento</a></h3></div>\n',MD.WMOFloat);
end

%informe de DMQC
fileReport=fullfile(GlobalDS.DirArgoData,'Floats','Informes',strcat(num2str(WMO),'InformeDMQC.pdf'));
if exist(fileReport,'file')==2
    fprintf(fid,'<h3><div align="center"><a href="http://www.oceanografia.es/argo/Informes/%7dInformeDMQC.pdf">Acceso al informe de Delayed Mode Quiality Control</a></h3></div>\n',MD.WMOFloat);
end
